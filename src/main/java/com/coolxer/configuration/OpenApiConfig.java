    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .components(new Components()
                        ...
                        .addSecuritySchemes("apiBearer", new SecurityScheme()
                                .type(SecurityScheme.Type.HTTP)
                                .scheme("bearer")
                                .description("普通 Web API 也支持 Bearer Token 鉴权，映射用户由 app.security.api.bearer-user 配置"))
                ...
                .addSecurityItem(new SecurityRequirement().addList("apiBearer"))
                .info(new Info()
                        .title("ZenVis API")
                        .version("v1")
